...
const STEPS = [
  { n: "01", title: "Upload your materials",   desc: "Add PDFs, Word docs, or paste text — StudyLM extracts and indexes every word." },
  { n: "02", title: "Choose your study mode",  desc: "Pick from Chat, Quiz, Flashcards, Summaries, or Mind Maps — or generate all at once." },
  { n: "03", title: "Study and ace your exams",desc: "Review AI-generated study materials, track your progress, and go into every exam prepared." },
] as const;
    ...
    >
      <div className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
        <div className="flex items-center gap-2.5">
          <img src="/logo.jpg" alt="StudyLM" className="w-8 h-8 rounded-lg object-cover shadow-sm" />
  ...
  return (
    <section className="relative pt-40 pb-32 px-6 overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto text-center">
        ...
        >
          Upload your lecture notes and textbooks. StudyLM's AI turns them into summaries,
          flashcards, quizzes, and mind maps — so you spend less time making notes and more
          ...
          <div className="grid grid-cols-4 h-64 md:h-80">
            ...
            <div className="col-span-1 border-r border-border p-4 hidden md:block">
              <div className="space-y-2">
                {["📚 Pharmacology", "🧬 Biochemistry", "📐 Statistics"].map((item) => (
                  <div
                    key={item}
            ...
            <div className="col-span-4 md:col-span-3 p-6">
              <div className="flex items-center gap-2 mb-4">
                ...
                <div>
                  <div className="text-sm font-medium">AI Summary — Pharmacology Unit 3</div>
                  <div className="text-xs text-text-muted">Generated in 2.4s · 47 tokens used</div>
                </div>
              </div>
              <div className="space-y-2">
                {[100, 80, 90, 70, 85].map((w, i) => (
                  <div key={i} className={`h-2.5 rounded-full bg-surface-2`} style={{ width: `${w}%` }} />
                ))}
              </div>
    ...
    <section id="features" className="py-24 px-6">
      <div className="max-w-6xl mx-auto">
        <AnimatedSection className="text-center mb-16">
          <motion.p variants={fadeUp} className="text-sm font-medium text-brand-primary uppercase tracking-widest mb-3">
            Features
          </motion.p>
          <motion.h2 variants={fadeUp} className="text-4xl md:text-5xl font-display">
            Everything you need to ace your exams
          </motion.h2>
          <motion.p variants={fadeUp} className="mt-4 text-text-secondary max-w-xl mx-auto">
            From first upload to final review — StudyLM handles the busywork so you can focus on understanding.
          </motion.p>
        </AnimatedSection>
          ...
          {STEPS.map((step) => (
            <motion.div key={step.n} variants={fadeUp} className="text-center">
              <div className="w-16 h-16 rounded-2xl gradient-brand flex items-center justify-center mx-auto mb-5 shadow-md">
                <span className="text-white text-xl font-display">{step.n}</span>
              </div>
    ...
    <section id="pricing" className="py-24 px-6">
      <div className="max-w-4xl mx-auto">
        ...
        <AnimatedSection className="grid md:grid-cols-2 gap-6 mb-10">
          ...
          >
            <p className="text-sm font-medium text-text-muted uppercase tracking-wider mb-4">Free</p>
            <div className="flex items-end gap-1 mb-2">
              <span className="text-5xl font-display">1,000</span>
              <span className="text-text-secondary mb-2">tokens</span>
            </div>
            <p className="text-sm text-text-secondary mb-6">On every new account — no credit card needed.</p>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="text-right">
                    ...
                    <p className="text-xs text-text-muted">
                      ₦{(pkg.price_ngn / pkg.tokens * 1000).toFixed(0)} / 1k tokens
                    </p>
                  </div>
                </div>
              </div>
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <p className="text-indigo-100 mb-8 text-lg">
                Join thousands of Nigerian students who are already acing their exams with AI.
              </p>
              <Link
                to="/auth?tab=signup"
    ...
    <footer className="border-t border-border py-10 px-6">
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
        ...
        <p className="text-xs text-text-muted text-center">
          © {new Date().getFullYear()} StudyLM. Built for Nigerian university students. 🇳🇬
        </p>
        <div className="flex items-center gap-5 text-xs text-text-muted">
          <Link to="/auth" className="hover:text-text-primary transition-colors">Sign in</Link>
          <Link to="/auth?tab=signup" className="hover:text-text-primary transition-colors">Sign up</Link>
          <a href="mailto:hello@studylm.app" className="hover:text-text-primary transition-colors">Contact</a>
        </div>
      </div>
    </footer>
  );
